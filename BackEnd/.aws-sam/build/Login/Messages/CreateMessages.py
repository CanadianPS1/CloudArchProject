...
def lambda_handler(event, context):
    try:
        ...
        #formatting thing for append, it wants it as a list
        newMessageList = [newMessage]
        ...
        return response(200, {"message": "Message created successfully", "message_id": message_id, "response Attributes":response['Attributes']})
